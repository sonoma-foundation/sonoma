...
/// mod item_wrapper {
/// use sonoma_sdk::keyed_account::KeyedAccount;
/// use sonoma_sdk::instruction::InstructionError;
/// use sonoma_sdk::pubkey::Pubkey;
/// use sonoma_sdk::declare_builtin;
///
...
///
/// # use item_wrapper::id;
/// assert_eq!(id(), sonoma_sdk::system_program::ID);
/// ```
#[macro_export]
