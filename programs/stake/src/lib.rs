...
#[deprecated(
    since = "1.8.0",
    note = "Please use `sonoma_sdk::stake::program::id` or `sonoma_program::stake::program::id` instead"
)]
pub use sonoma_sdk::stake::program::{check_id, id};
use sonoma_sdk::{
...
pub fn get_minimum_delegation(feature_set: &FeatureSet) -> u64 {
    if feature_set.is_active(&feature_set::stake_raise_minimum_delegation_to_1_sol::id()) {
        ...
        #[allow(deprecated)]
        sonoma_sdk::stake::MINIMUM_STAKE_DELEGATION
    }
}
