...
mod tests {
    ...
    use {
        super::*,
        sonoma_program_runtime::{invoke_context::InvokeContext, sysvar_cache::SysvarCache},
        solana_rbpf::{
    ...
    fn test_translate_type() {
        ...
        let instruction = Instruction::new_with_bincode(
            ...
            &"foobar",
            vec![AccountMeta::new(sonoma_sdk::pubkey::new_rand(), false)],
        );
    ...
    fn test_translate_slice() {
        ...
        *data.first_mut().unwrap() = 10;
        ...
        // Pubkeys
        let mut data = vec![sonoma_sdk::pubkey::new_rand(); 5];
        let addr = data.as_ptr() as *const _ as u64;
        let memory_mapping = MemoryMapping::new::<UserError>(
            vec![
                MemoryRegion::default(),
        ...
        let translated_data =
            translate_slice::<Pubkey>(&memory_mapping, 0x100000000, data.len() as u64, true, true)
                .unwrap();
        assert_eq!(data, translated_data);
        *data.first_mut().unwrap() = sonoma_sdk::pubkey::new_rand(); // Both should point to same place
        assert_eq!(data, translated_data);
    }
    ...
    fn test_create_program_address() {
        // These tests duplicate the direct tests in sonoma_program::pubkey
