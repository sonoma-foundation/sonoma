...
impl AccountsDb {
    ...
    pub fn new_with_config(
        ...
        let filler_account_suffix = if filler_accounts_config.count > 0 {
            Some(sonoma_sdk::pubkey::new_rand())
        } else {
            None
        };
    ...
    fn hash_account_data(
        ...
        Hash::new_from_array(
            <[u8; sonoma_sdk::hash::HASH_BYTES]>::try_from(hasher.finalize().as_slice()).unwrap(),
        )
    }
    ...
    fn get_filler_account_pubkeys(&self, count: usize) -> Vec<Pubkey> {
        (0..count)
            .map(|_| {
                let subrange = sonoma_sdk::pubkey::new_rand();
...
pub mod tests {
    ...
    fn test_accounts_db_serialize_zero_and_free() {
        ...
        let filler_account_pubkey = sonoma_sdk::pubkey::new_rand();
        ...
        F: Fn(AccountsDb, Slot) -> AccountsDb,
    {
        ...
        let pubkey = sonoma_sdk::pubkey::new_rand();
        let purged_pubkey1 = sonoma_sdk::pubkey::new_rand();
        let purged_pubkey2 = sonoma_sdk::pubkey::new_rand();
    ...
    fn test_verify_bank_capitalization() {
        ...
        let native_account_pubkey = sonoma_sdk::pubkey::new_rand();
        db.store_uncached(
            some_slot,
            &[(
                &native_account_pubkey,
                &sonoma_sdk::native_loader::create_loadable_account_for_test("foo"),
            )],
        );
        db.update_accounts_hash_test(some_slot, &ancestors);
        assert_matches!(
    ...
    fn test_storage_finder() {
        ...
        let lamports = 100;
        let data_len = 8190;
        let account = AccountSharedData::new(lamports, data_len, &sonoma_sdk::pubkey::new_rand());
    ...
    fn test_accounts_purge_long_chained_after_snapshot_restore() {
        ...
        let pubkey = sonoma_sdk::pubkey::new_rand();
        let dummy_pubkey = sonoma_sdk::pubkey::new_rand();
        let purged_pubkey1 = sonoma_sdk::pubkey::new_rand();
        let purged_pubkey2 = sonoma_sdk::pubkey::new_rand();
    ...
    fn test_shrink_stale_slots_processed() {
        ...
        for startup in &[false, true] {
            ...
            let pubkeys: Vec<_> = (0..pubkey_count)
                .map(|_| sonoma_sdk::pubkey::new_rand())
                .collect();
    ...
    fn test_account_balance_for_capitalization_sysvar() {
        let normal_sysvar = sonoma_sdk::account::create_account_for_test(
            &sonoma_sdk::slot_history::SlotHistory::default(),
        );
    ...
    fn test_flush_accounts_cache() {
        ...
        let root5 = 5;
        let root6 = 6;
        let unrooted_key = sonoma_sdk::pubkey::new_rand();
        let key5 = sonoma_sdk::pubkey::new_rand();
        let key6 = sonoma_sdk::pubkey::new_rand();
    ...
    fn test_calculate_storage_count_and_alive_bytes() {
        let accounts = AccountsDb::new_single_for_tests();
        let shared_key = sonoma_sdk::pubkey::new_rand();
        let account = AccountSharedData::new(1, 1, AccountSharedData::default().owner());
        let slot0 = 0;
    ...
    fn test_calculate_storage_count_and_alive_bytes_2_accounts() {
        let accounts = AccountsDb::new_single_for_tests();
        let keys = [
            sonoma_sdk::pubkey::Pubkey::new(&[0; 32]),
            sonoma_sdk::pubkey::Pubkey::new(&[255; 32]),
        ];
    ...
    fn test_clean_accounts_with_last_full_snapshot_slot() {
        ...
        let accounts_db = AccountsDb::new_single_for_tests();
        let pubkey = sonoma_sdk::pubkey::new_rand();
        let owner = sonoma_sdk::pubkey::new_rand();
        let space = 0;
