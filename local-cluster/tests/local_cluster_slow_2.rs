...
fn test_slot_hash_expiry() {
    solana_logger::setup_with_default(RUST_LOG_FILTER);
    sonoma_sdk::slot_hashes::set_entries_for_tests_only(64);
    ...
    info!(
        ...
        sonoma_sdk::slot_hashes::get_entries()
    );
    ...
    loop {
        ...
        if last_vote_on_a
            >= common_ancestor_slot + 2 * (sonoma_sdk::slot_hashes::get_entries() as u64)
        {
