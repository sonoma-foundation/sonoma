...
/// documentation.
///
/// [`Finalized`]: sonoma_sdk::commitment_config::CommitmentLevel::Finalized
/// [`Processed`]: sonoma_sdk::commitment_config::CommitmentLevel::Processed
...
///
/// ```
/// # use sonoma_sdk::system_transaction;
/// # use solana_client::rpc_client::RpcClient;
/// # use solana_client::client_error::ClientError;
/// # use sonoma_sdk::signature::{Keypair, Signer};
/// # use sonoma_sdk::hash::Hash;
/// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
/// # let key = Keypair::new();
/// # let to = sonoma_sdk::pubkey::new_rand();
/// # let lamports = 50;
...
impl RpcClient {
    ...
    ///
    /// [`CommitmentLevel`]: sonoma_sdk::commitment_config::CommitmentLevel
    ///
    /// # Examples
    ///
    /// ```
    /// # use sonoma_sdk::commitment_config::CommitmentConfig;
    /// # use solana_client::rpc_client::RpcClient;
    /// let url = "http://localhost:8899".to_string();
    ...
    ///
    /// [`TransactionError`]: sonoma_sdk::transaction::TransactionError
    ///
    /// This function only searches a node's recent history, including all
    /// recent slots, plus up to
    /// [`MAX_RECENT_BLOCKHASHES`][sonoma_sdk::clock::MAX_RECENT_BLOCKHASHES]
    ...
    /// #     client_error::ClientError,
    /// # };
    /// # use sonoma_sdk::slot_history::Slot;
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// let start_slot = 1;
    /// let limit = 3;
    ...
    /// [`Confirmed`].
    ///
    /// [`Confirmed`]: sonoma_sdk::commitment_config::CommitmentLevel::Confirmed
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`getBlocks`] RPC method, unless
